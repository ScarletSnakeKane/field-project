...
/* Адрес заводской калибровки VREFINT берём из HAL (stm32f4xx_ll_adc.h), а не
 * дублируем своим define: значения совпадают, но собственная копия молча
 * разошлась бы с драйвером при смене семейства МК. */
